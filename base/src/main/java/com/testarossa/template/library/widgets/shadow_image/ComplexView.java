package com.testarossa.template.library.widgets.shadow_image;
...
public class ComplexView extends RelativeLayout implements View.OnClickListener, Animation.AnimationListener {
    ...
    private void init(AttributeSet set) {
        ...
        String shadowColor = ta.getString(R.styleable.ComplexView_shadowColorView);
        if (shadowColor == null) {
            shadowColor = "000000";
        }
    ...
    private void setGradientAngle(String gradientAngle) {
        ...
        gd.setOrientation(GradientDrawable.Orientation.valueOf(gradientAngle.toUpperCase(Locale.getDefault())));
    }
